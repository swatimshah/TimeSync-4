...
csv_file = "frame_eeg.csv"

frame_ts = loadtxt('D:\\recording\\video_frame_timestamp.csv', delimiter=',', skiprows=1)
print(frame_ts[:, 0].shape)

channels_ts = loadtxt('D:\\recording\\filtered_signal_50Hz_outliers_zero_mean.csv', delimiter=',', skiprows=1)
